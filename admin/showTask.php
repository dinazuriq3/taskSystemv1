          ...
          <div class="col-lg-12">
            ...
            <div class="row"><div class="col-sm-12 ">
                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">user </th>
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="">action</th>
                          ...
                          <td>
                              <?php if($tasks['taskStatus']==1){
                                 ...
                                 echo "approved";                                 
                                  ...
                                  <td>
                       <a href="handlers/delete_task.php?taskId=<?= $tasks['taskId']?>"><i class="fas fa-trash-alt btn btn-danger"></i></a>
                       <a href="handlers/approve_task.php?taskId=<?= $tasks['taskId']?>"><i class="fas fa-trash-alt btn btn-danger"></i></a>
              ...
              <?php
                ...
                ?>
                  ...
                  <th rowspan="1" colspan="1" style="">user</th>
